...
const WORDS = ["Hi, I'm Ayush","Computer Science Student", "Tech Enthusiast","Crafting Code"];
const TECH_STACK = ["React", "Javascript", "Node.js", "HTML","CSS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ayushguptakr" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ayush-gupta-9761831b4/" },
  { icon: Instagram, link: "https://www.instagram.com/ayush_gupta_xo/" }
];
